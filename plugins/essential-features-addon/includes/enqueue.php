...
function efa_elementor_script_libs (): void {
	...
	if ( $efa_check_elementor == 'builder' ) {
		// bootstrap
		wp_enqueue_style( 'bootstrap', EFA_PLUGIN_URL . 'assets/libs/bootstrap/bootstrap.min.css' );
		wp_enqueue_script( 'bootstrap', EFA_PLUGIN_URL . 'assets/libs/bootstrap/bootstrap.bundle.min.js', array('jquery'), null, true );
