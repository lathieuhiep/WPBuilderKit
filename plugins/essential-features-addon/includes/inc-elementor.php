...
function efa_register_widget_elementor_addon( $widgets_manager ): void {
	...
	require_once EFA_PLUGIN_PATH . 'includes/widgets/elementor/icon-text.php';
	require_once EFA_PLUGIN_PATH . 'includes/widgets/elementor/icon-text-grid.php';
	...
	$widgets_manager->register( new \EFA_Widget_Icon_Text() );
	$widgets_manager->register( new \EFA_Widget_Icon_Text_Grid() );
