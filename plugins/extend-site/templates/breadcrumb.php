...
<nav class="es-breadcrumb" aria-label="Breadcrumb">
    <ol class="es-breadcrumb__list" itemscope itemtype="https://schema.org/BreadcrumbList">
        ...
        foreach ($items as $index => $item) :
            ...
            $position = $index + 1; // Vị trí bắt đầu từ 1 cho Schema
            ?>
            <li class="es-breadcrumb__item" itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem">
                ...
                <?php if (!$is_last) : ?>
                    <span class="es-breadcrumb__separator" aria-hidden="true">&#62;</span>
                <?php endif; ?>
            </li>
        <?php endforeach; ?>
    </ol>
